...
<body>
    <div class="main-content">
        <div class="header">
            <div class="page-title">Dashboard Donatur</div>
                                ...
                                @if(isset($donations))
                                    @forelse($donations as $donation)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('donations.show', $donation->id) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                                    <a href="{{ route('donations.edit', $donation->id) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                    ...
                                    @empty
                                        <tr><td colspan="7" class="text-center">Belum ada donasi</td></tr>
                                    @endforelse
                                @else
                                    <tr><td colspan="7" class="text-center">Data donasi tidak tersedia</td></tr>
                                @endif
                            </tbody>
                        </table>
                    </div>
